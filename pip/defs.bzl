...
pip_vendor_label = Label("@jiko_devx_bazel_rules_python_docker//pip:third_party/py/BUILD")
...
"""),
        ...
        "_script": attr.label(
            executable = True,
            default = Label("@jiko_devx_bazel_rules_python_docker//pip/src:piptool.py"),
            allow_single_file = True,
            cfg = "exec",
        ),
        "_compiler": attr.label(
            executable = True,
            default = Label("@jiko_devx_bazel_rules_python_docker//pip/src:compile.py"),
            allow_single_file = True,
            cfg = "exec",
        ),
        "quiet": attr.bool(
...
whl_library = repository_rule(
    attrs = {
        ...
        "_script": attr.label(
            executable = True,
            default = Label("@jiko_devx_bazel_rules_python_docker//pip/src:whl.py"),
            cfg = "exec",
        ),
        "quiet": attr.bool(
            default = True,
